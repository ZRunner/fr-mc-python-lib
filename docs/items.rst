...
When you search with the :func:`~frmc_lib.search_item` function, you get an :class:`~frmc_lib.Entity` object that summarizes all the characteristics of the entity.
